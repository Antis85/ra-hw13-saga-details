...
export function addServicesRequest(item) {
  return { type: ADD_SERVICES_REQUEST, payload: { item } };
}
...
export function editServicesRequest(options) {
  return { type: EDIT_SERVICES_REQUEST, payload: { ...options } };
}
